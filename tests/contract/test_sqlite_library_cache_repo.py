...
from app.domain import Album, Artist, CatalogSearchResults, TrackAiUsage, TrackCredit
...
def test_sqlite_library_cache_repo_preserves_credits_on_plain_metadata_refresh(tmp_path) -> None:
    repo = SQLiteLibraryCacheRepo(db_path=tmp_path / "library.sqlite3")
    track = Track(
        id="track-1",
        title="Signal",
