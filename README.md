...
- настройка `Меньше AI-музыки`, которая синхронизируется с аккаунтом Яндекс Музыки и уменьшает количество AI-контента в рекомендациях (по умолчанию выключена);
- полная информация о треке из контекстного меню: участники, сведения правообладателя и разметка использования AI; AI-треки также получают метку `AI` при воспроизведении;
