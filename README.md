...
`YaYmp` — Yet Another Yandex Music Player неофициальный десктопный клиент для Яндекс Музыки.
...
- сохранение текущей очереди в новый или существующий серверный плейлист;
