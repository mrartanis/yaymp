    ...
    def _save_track_metadata_with_connection(
        ...
        connection.execute(
            (
                ...
                "credits_cached_at, credits_language, ai_usage, cached_at"
                ") values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) "
                ...
                "credits_language = case when excluded.credits_cached_at is null "
                "then tracks.credits_language else excluded.credits_language end, "
